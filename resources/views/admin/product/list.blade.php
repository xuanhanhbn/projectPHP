                    ...
                    <div class="card-tools">
                        <form action="{{url("admin/product/list/")}}" method="get">
                            <div class="d-flex align-items-center">
                                <div class="input-group input-group-sm mr-20 ">
                                ...
                                <div class="input-group input-group-sm">
                                    <input value="{{app("request")->input("search")}}" type="text" name="search" class="form-control " placeholder="Search">

                                </div>
                                <div class="input-group input-group-sm icon-look">
