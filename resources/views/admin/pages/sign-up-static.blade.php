...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ route('admin.home') }}">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="{{ route('admin.profile-static') }}">
                        <i class="fa fa-user opacity-6  me-1"></i>
                        Profile
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="{{ route('admin.sign-up-static') }}">
                        <i class="fas fa-user-circle opacity-6  me-1"></i>
                        Sign Up
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="{{ route('admin.sign-in-static') }}">
