<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('admin.home') }}"
            target="_blank">
            <span class="ms-1 font-weight-bold" style="font-size: 24px">Arts Admin Portal</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item mt-3 d-flex align-items-center">
                <div class="ps-4">
                    <i class="fa fa-th-large me-xl" style="color: #f4645f;"></i>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin.order.list' ? 'active' : '' }}" href="{{ route('admin.order.list') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                <div class="ps-4">
                    <i class="fa fa-user me-xl" style="color: #f4645f;"></i>
                </div>
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Account Manager</h6>
            </li>
            <li class="nav-item">
