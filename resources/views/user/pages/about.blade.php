                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="{{route("user_home")}}">Men's</a></li>
                            <li class="scroll-to-section"><a href="{{route("user_home")}}">Women's</a></li>
                            <li class="scroll-to-section"><a href="{{route("user_home")}}">Kid's</a></li>
                            <li class="submenu">
                            ...
                            <li class="scroll-to-section"><a href="{{route("user_home")}}">Explore</a></li>
                        </ul>        
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-image">
                        <img src="user/assets/images/about-left-image.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="service-item">
                        ...
                        <img src="user/assets/images/service-01.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="service-item">
                        ...
                        <p>Lorem ipsum dolor sit amet, consecteturti adipiscing elit, sed do eiusmod temp incididunt ut labore, et dolore quis ipsum suspend.</p>
                        <img src="user/assets/images/service-02.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="service-item">
                        ...
                        <p>Lorem ipsum dolor sit amet, consecteturti adipiscing elit, sed do eiusmod temp incididunt ut labore, et dolore quis ipsum suspend.</p>
                        <img src="user/assets/images/service-03.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
